...
@NoArgsConstructor
@AllArgsConstructor
public class VideoCaptureDto implements Serializable {
    ...
    @NotNull(message = "Is Created is required", groups = {OnCreate.class})
    ...
    public String getStatusText() {
        return VideoCaptureEnum.fromCode(this.status);
    }
}
